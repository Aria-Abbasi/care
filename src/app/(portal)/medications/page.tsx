...
export default function AdminMedicationsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"active" | "discontinued" | "all">("active");
  ...
  // Form: Discontinue other active medications
  ...
  function openEditModal(med: Medication) {
    ...
    // Editing only updates core medication attributes
  ...
  async function handleSaveMed() {
    ...
    try {
      if (editingMed) {
        ...
        showToast("دارو با موفقیت ویرایش شد.");
      } else {
  ...
  // Active meds eligible to be discontinued in modal
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
          <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-slate-100 flex items-center gap-2.5">
            ...
            <span>مرکز جامع مدیریت داروها، نسخه و موجودی</span>
          </h1>
          <p className="text-xs sm:text-sm font-semibold text-slate-500 dark:text-slate-400 mt-1">
            شماره جعبه در منزل، دستور پزشک، ایجاد خودکار تسک مصرف و تاریخچه توقف داروها
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        {/* Tabs */}
        <div className="flex items-center gap-1 bg-white dark:bg-slate-900 p-1 rounded-2xl border border-slate-200 dark:border-slate-800 w-full sm:w-auto">
          <button
          ...
          >
            ...
            <span>داروهای فعال در منزل</span>
          ...
          >
            ...
            <span>سوابق داروهای متوقف‌شده</span>
            <span className="px-1.5 py-0.2 rounded-md bg-white/20 text-[10px] font-mono">
        ...
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            placeholder="جستجوی نام دارو، جعبه (مثلاً ۱ یا ۸)، نام پزشک یا علت توقف..."
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredMeds.map((med) => {
            ...
            return (
              ...
              >
                <div>
                  {/* Card Top: Name + Box Number + Role actions */}
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {userRole === "ADMIN" && (
                      <button
                        ...
                        title="ویرایش اطلاعات پایه دارو"
                      >
                    ...
                    {med.schedules && med.schedules.length > 0 && (
                      <div className="flex items-center gap-1.5 flex-wrap pt-1">
                        ...
                        {med.schedules.map((sc) => (
                          <span
                            key={sc.id}
                            className="px-2 py-0.5 rounded-lg bg-care-50 dark:bg-emerald-950/40 text-care-800 dark:text-emerald-300 border border-care-200 dark:border-emerald-800 text-[10px] font-bold"
                          >
                            ساعت {toPersianDigits(sc.targetTime)}
                          </span>
                        ))}
                      </div>
                    )}
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 overflow-hidden">
          <div className="bg-white dark:bg-slate-900 w-full max-w-2xl max-h-[90vh] flex flex-col rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-base font-black text-slate-900 dark:text-slate-100">
                    {editingMed ? "ویرایش مشخصات دارو" : "ثبت داروی جدید و پروتکل مصرف"}
                  </h2>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">
                    {editingMed
                      ? "اصلاح شماره جعبه، دستورات یا موجودی"
            ...
            <div className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
              ...
              {/* Section 3: Automatic Schedule Generator (Only for Create) */}
              {!editingMed && (
                <div className="space-y-3 pt-2">
                        ...
                        <div className="p-2.5 rounded-xl bg-white/70 dark:bg-slate-800/70 border border-indigo-100 dark:border-indigo-900/40 space-y-2">
                          <label className="flex items-center gap-2 cursor-pointer">
                            ...
                            <span className="text-[11px] font-bold text-slate-700 dark:text-slate-300">
                              پایان دوره مصرف دارد (تسک محدود است)
                            </span>
                          </label>
